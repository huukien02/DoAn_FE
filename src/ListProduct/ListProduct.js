...
function ListProduct() {
    ...
    useEffect(() => {
        axios
            .get("http://localhost:4000/api/listpet/type/rau")
            .then(res => setDataDog(res.data));
    }, []);

    useEffect(() => {
        axios
            .get("http://localhost:4000/api/listpet/type/thit")
    ...
    return (
        <div className='container'>
            <div className='listPet'>
                <div className='left'>
                    <img src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTu0XxMC2jd1wB_s1JzmZ6iVp91U6AgENIA6rzbpC-zWMKVCwfInOmwNv7iaRbiowcQso8&usqp=CAU' />
                </div>
